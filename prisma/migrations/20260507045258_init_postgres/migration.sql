...
CREATE TABLE "criteria_groups" (
    ...
    CONSTRAINT "criteria_groups_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "criteria" (
    ...
    "deductionPerError" DOUBLE PRECISION NOT NULL DEFAULT 1.0,
    "maxDeduction" DOUBLE PRECISION NOT NULL DEFAULT 5.0,
...
CREATE TABLE "checklist_forms" (
    ...
    CONSTRAINT "checklist_forms_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "checklist_section_items" (
    ...
    CONSTRAINT "checklist_section_items_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "audits" (
    ...
    "storeId" TEXT NOT NULL,
    "auditorId" TEXT NOT NULL,
    "finalScore" DOUBLE PRECISION NOT NULL DEFAULT 100.0,
...
CREATE TABLE "group_scores" (
    ...
    "reachedScore" DOUBLE PRECISION NOT NULL,
...
-- AddForeignKey
ALTER TABLE "stores" ADD CONSTRAINT "stores_amId_fkey" FOREIGN KEY ("amId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "criteria" ADD CONSTRAINT "criteria_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "criteria_groups"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "checklist_sections" ADD CONSTRAINT "checklist_sections_formId_fkey" FOREIGN KEY ("formId") REFERENCES "checklist_forms"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "checklist_sections" ADD CONSTRAINT "checklist_sections_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "criteria_groups"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "checklist_section_items" ADD CONSTRAINT "checklist_section_items_sectionId_fkey" FOREIGN KEY ("sectionId") REFERENCES "checklist_sections"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "checklist_section_items" ADD CONSTRAINT "checklist_section_items_criteriaId_fkey" FOREIGN KEY ("criteriaId") REFERENCES "criteria"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "audit_plans" ADD CONSTRAINT "audit_plans_formId_fkey" FOREIGN KEY ("formId") REFERENCES "checklist_forms"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "audit_assignments" ADD CONSTRAINT "audit_assignments_planId_fkey" FOREIGN KEY ("planId") REFERENCES "audit_plans"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "audit_assignments" ADD CONSTRAINT "audit_assignments_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "stores"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "audit_assignments" ADD CONSTRAINT "audit_assignments_auditId_fkey" FOREIGN KEY ("auditId") REFERENCES "audits"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "audits" ADD CONSTRAINT "audits_formId_fkey" FOREIGN KEY ("formId") REFERENCES "checklist_forms"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "group_scores" ADD CONSTRAINT "group_scores_auditId_fkey" FOREIGN KEY ("auditId") REFERENCES "audits"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "violations" ADD CONSTRAINT "violations_auditId_fkey" FOREIGN KEY ("auditId") REFERENCES "audits"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "violations" ADD CONSTRAINT "violations_criteriaId_fkey" FOREIGN KEY ("criteriaId") REFERENCES "criteria"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "evidences" ADD CONSTRAINT "evidences_violationId_fkey" FOREIGN KEY ("violationId") REFERENCES "violations"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "action_plans" ADD CONSTRAINT "action_plans_auditId_fkey" FOREIGN KEY ("auditId") REFERENCES "audits"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "action_plans" ADD CONSTRAINT "action_plans_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "stores"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "action_plans" ADD CONSTRAINT "action_plans_closedById_fkey" FOREIGN KEY ("closedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
